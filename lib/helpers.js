...
module.exports.getObjectById = (array, id) => {
  const found = array.find((element) => element.id === Number(id));
  return found;
};

module.exports.getNameById = (array, id) => {
  const found = array.find((element) => element.id === Number(id));
  if (found) {
    return found.name;
  } else {
...
module.exports.setManager = (managers, userId) => {
...
module.exports.setLeague = (leagues, managerId) => {
  let leagueToReturn;
...
module.exports.setManagersByLeague = (league, managers) => {
...
module.exports.getPlayersManager = (players, managers) => {
...
module.exports.getPlayerIdsFromTeamId = (players, teamId) => {
  const playerIds = [];
...
module.exports.getUnpickedPlayers = (managers, players, league) => {
...
module.exports.getTransferPlayers = (managers, players, league) => {
  const pickedPlayerIds = [];
  managers.forEach((manager) => {
    pickedPlayerIds.push(...manager.stage1Squad);
  });
...
module.exports.getManagerByPickNumber = (stage, managers, pickNumber) => {
  if (stage === 1) {
...
module.exports.getStage2Managers = (league, managers) => {
...
module.exports.getStage3Managers = (league, managers) => {
