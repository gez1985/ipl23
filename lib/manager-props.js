...
const sortObjects = require("./sort-objects");

module.exports.getManagerProperties = (managers, players) => {
  ...
  getStagePoints(managers, players);
};

const getStagePoints = (managers, players) => {
  const reducer = (accumulator, currentValue) => accumulator + currentValue;
  managers.forEach((manager) => {
    manager.stage1BestEleven = getStage1BestEleven(manager, players);
    manager.stage2BestEleven = getStage2BestEleven(manager, players);
    manager.stage3BestEleven = getStage3BestEleven(manager, players);
...
const getStage1BestEleven = (manager, players) => {
...
const getStage2BestEleven = (manager, players) => {
...
const getStage3BestEleven = (manager, players) => {
