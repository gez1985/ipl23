...
module.exports.getAllScores = async () => {
  try {
...
module.exports.getAllFixtures = async () => {
  try {
...
module.exports.getAllLeagues = async () => {
  try {
...
module.exports.getAllVidiprinter = async () => {
  try {
...
module.exports.getLeagueById = async (leagueId) => {
  try {
...
module.exports.putManager = async (manager) => {
  try {
...
module.exports.putLeague = async (league) => {
  try {
...
module.exports.postVidiprinter = async (entry) => {
  try {
...
module.exports.getVidiprinterById = async (leagueId) => {
  try {
