      ...
      <div className="standard-width-container">
        <div className="rules-section">
          ...
          <ul className="rules-ul">
            ...
            <li>
              In the initial draft managers will pick a squad of 15 players. In
              subsequent drafts managers will pick 11 players.
            </li>
            <li>
              In the initial draft No more than three players can be selected
              from the same team. In the semi-final draft the limit is four and
            ...
            <li>
              ...
              the semi-final and final drafts.
              <table className="rules-table">
                <thead>
                  <tr>
                    <th rowSpan="2"></th>
                    <th colSpan="2">Initial Draft</th>
                    <th colSpan="2">Later Drafts</th>
                  </tr>
                  <tr>
                    <td>Min</td>
                    <td>Max</td>
        ...
        <div className="rules-section">
          ...
          <ul className="rules-ul">
            ...
            <li>
              In the semi-finals and final all eleven players in the squad will
              score points.
            </li>
            <li>
        ...
        <div className="rules-section">
          ...
          <ul className="rules-ul">
            <li>
              At the end of the first round (set by the league admin), the
              managers with the highest points total will qualify for the
              semi-finals. In the event of a tie, league order will be decided
              by the manager with the most catches scored by the entire squad.
              If this is also a tie, the fall back criteria will be: most runs,
              most wickets, most run outs, most appearances played and finally a
              coin toss.
            </li>
            <li>
              Before the semi-final begins, qualified players will be redrafted
              by the qualified managers. Should qualifying players be in the
              qualifying manager's squads, managers will carry these players
              through to their semi-final squad. Their turn or pick position
              will not be affected. The semi-final draft order will be
              determined by the total points scored by the squads selected in
              the first draft. The manager with the most points will get first
              pick. The order will reverse each round as per the original draft.
            </li>
            <li>
            ...
            <li>
              The winning semi-final managers will qualify for the Euro Draft
              Final.
            </li>
            <li>
              ...
              qualifying manager's squads, managers will carry these players
              through to their final squad. Their turn or pick position will not
              be affected. The final draft order will be determined by the total
        ...
        <div className="rules-section">
          ...
          <ul className="rules-ul">
            <li>
              The Euro Draft is a not for profit competition and prize
              allocation is best set by individual leagues. The table below
              shows a suggested split of the prize purse.
            </li>
            <table className="rules-table">
              <tbody>
                <tr>
            ...
            <li>
              Participants may also wish to consider a suitable forfeit for last
              place.
            </li>
            <li>
              Participants may request a certificate of participation from their
              league admin within three days of the final.
            </li>
          </ul>
        </div>
      </div>
