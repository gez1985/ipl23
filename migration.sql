...
CREATE TABLE leagues (
  ...
  draft_2_live BOOLEAN NOT NULL DEFAULT false,
  draft_3_live BOOLEAN NOT NULL DEFAULT false,
  ...
  stage_4_managers SMALLINT[][2] DEFAULT '{}',
  stage_4_teams SMALLINT[] DEFAULT '{}'
);
